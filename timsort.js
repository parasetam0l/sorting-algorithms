Array.prototype.timsort = function(simulation){
    ...
    function binarySort (a, lo, hi, start, compare) {
        ...
        for (; start < hi; start++) {
            ...
            */
            ...
            switch (n) {
            case 2:
                sim.pushState(a, [left + 2, left + 1])
                a[left + 2] = a[left + 1];
            case 1:
                sim.pushState(a, [left + 1, left])
                a[left + 1] = a[left];
                break;
            default:
            arraycopy(a, left, a, left + 1, n);
            }
            sim.pushState(a, [left, start])
            a[left] = pivot;
        }
    }
